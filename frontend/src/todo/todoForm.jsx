    ...
    render() {
        ...
        return (
            <div role="form" className="todoForm">
                <Grid cols='12 9 10'>
                    <input type="text" id="description" onKeyUp={this.keyHandler} className="form-control" placeholder="Add a task here" onChange={this.props.changeDescription} value={this.props.description}/>
                </Grid>
                <Grid cols='12 3 2'>
